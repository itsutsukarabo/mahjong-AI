"""
手牌類推モデル v41: yaku_head 統合・固定特徴量 695→674次元
...
v41 からの変更:
  ...
  4. データファイル: hand_inference_v41.ndjson (label_yaku / label_won フィールド付き)
"""
...
MODEL_DIR = Path(__file__).parent.parent / "models" / "hand_inference" / "v41"
