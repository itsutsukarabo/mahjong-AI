"""
手牌類推モデル v9: v7 から d_model を 128→256 に拡大 (ablation C)
...
MODEL_DIR = Path(__file__).parent.parent / "models" / "hand_inference" / "v9"
...
VISIBLE_OFFSET     = 185
GPU_TEMP_THRESHOLD = 65   # °C を超えたら冷却待機 (d_model=256で発熱増のため低めに設定)
