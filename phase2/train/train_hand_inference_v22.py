"""
手牌類推モデル v22: pass_chi_signal + chi_called_tile_signal 追加 (442次元入力)

v21からの変更点:
  - input_dim: 374 → 442 (pass_chi_signal 34次元 + chi_called_tile_signal 34次元追加)
  - データ: hand_inference_v22.ndjson (新データパイプライン)

v21 の設定を引き継ぐ:
  - LAMBDA_BLOCK=0.3, pos_weight上限10, block_head 2層, 終盤重み付きNLL
"""
...
MODEL_DIR = Path(__file__).parent.parent / "models" / "hand_inference" / "v22"
...
def main():
    ...
    ndjson_path = DATA_DIR / "hand_inference_v22.ndjson"
