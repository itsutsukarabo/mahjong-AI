"""
手牌類推モデル v13: v11 + MSE合計ペナルティ復活 + 勾配クリッピング
...
MODEL_DIR = Path(__file__).parent.parent / "models" / "hand_inference" / "v13"
